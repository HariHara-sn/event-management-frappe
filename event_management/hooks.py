...
app_publisher = "Hari Hara Sudhan"
app_description = "A Frappe-based web application to manage events, attendees, and ticket sales."
app_email = "hariharasudhans.dev@gmail.com"
app_license = "mit"
